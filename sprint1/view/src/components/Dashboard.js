  ...
  const fetchDashboardData = React.useCallback(async () => {
    try {
      const [todayResponse, recentResponse, statsResponse] = await Promise.all([
        fetch('/actions/today', { credentials: 'include' }),
        fetch('/actions/recent', { credentials: 'include' }),
        fetch('/actions/stats', { credentials: 'include' })
      ]);
      ...
      setStats(prevStats => ({
        ...
        weeklyActions: statsData.weeklyActions || 0,
        totalActions: statsData.totalImpact.totalActions || 0,
        totalCO2Saved: statsData.totalImpact.totalCO2Saved || 0,
        totalWaterSaved: statsData.totalImpact.totalWaterSaved || 0,
        totalTreesPreserved: statsData.totalImpact.totalTreesPreserved || 0
      }));
          ...
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-green-50 p-4 rounded-lg">
                <h4 className="font-medium text-gray-800">CO₂ Saved</h4>
                <p className="text-2xl font-bold text-gray-900">{stats.totalCO2Saved} kg</p>
              </div>
              <div className="bg-blue-50 p-4 rounded-lg">
                <h4 className="font-medium text-gray-800">Water Saved</h4>
                <p className="text-2xl font-bold text-gray-900">{stats.totalWaterSaved} L</p>
              </div>
              <div className="bg-yellow-50 p-4 rounded-lg">
                <h4 className="font-medium text-gray-800">Trees Preserved</h4>
                <p className="text-2xl font-bold text-gray-900">{stats.totalTreesPreserved}</p>
              </div>
            </div>
          </div>
        </div>
